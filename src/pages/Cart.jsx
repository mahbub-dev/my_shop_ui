...
const Cart = () => {
	...
	const quantity = useSelector((state) => state.changeNum.value);
	...
	return (
		<Container>
			...
			<Wrapper>
				...
				<Top>
					<TopButton>CONTINUE SHOPPING {cart.quantity}</TopButton>
					<TopTexts>
